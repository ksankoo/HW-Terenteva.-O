...
const myFirstArray = ["Hello, world", 1998, true];
console.log(myFirstArray);

//Задание 2
//Создайте массив mySecondArray, заполните его любыми значениями. Выведите длину массива.

const mySecondArray = ["Аусси", "Бультерьер", "Хилер", "Бобтейл"];
...
const myInformation = ["Оксана", "19", "Октябрь", "Весы"];
...
let moreRussianCities = ['Санкт-Петербург', 'Москва', 'Екатеринбург'];
let cities = [...moreRussianCities, ...russianCities];
console.log(cities);
...
let filterEvenNumbers = function(x) {
    let evenNumbers = x.filter(el => el % 2 == 0);
    return evenNumbers;
}
