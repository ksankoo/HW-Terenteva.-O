...
let worker1 = new Worker('Оксана', 'Терентьева');
console.log(worker1);
...
const worker2 = new Worker('Иван', 'Иванов');
...
const car2 = new Car('Ford', 'Focus', 2010);
...
const rectangle2 = new Rectangle(200, 100);
...
const student = new Student('Ginger', 15, 5);
console.log(student);
...
const student2 = new Student('Crissy', 14, 3);
...
const book = new Book ('Игра Престолов', 'Джордж Мартин', 1996);
console.log(book);
...
const book2 = new Book ('Сумерки', 'Стефани Майер', 2005);
...
const account = new BankAccount (232323, 2000);
console.log(account);
...
const account2 = new BankAccount (343434, 3000);
...
const account3 = new BankAccount (454545, 5000);
console.log(account3.withdraw(6000));
...
const person = new Person ('Маша', 23, 'Сочи');
console.log(person);
...
const person2 = new Person ('Зина', 27, 'Иркутск');
console.log(person2.changeCity('Новый Уренгой'));
...
const employee = new Employee ('Светлана', 'CEO', 1500000);
...
const employee2 = new Employee ('Валерия', 'Designer', 300000);
...
const product = new Product ("Молоко", 85, 2);
console.log(product);
...
const product2 = new Product ('Хлеб', 10, 5);
...
const triangle2 = new Triangle (5, 7, 9);
